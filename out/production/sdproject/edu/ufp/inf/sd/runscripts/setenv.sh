...
#@REM =====================================================================================================
# @REM ==== PC STUFF ====
export JDK=/home/elisio/.jdks/openjdk-14.0.1
...
export USERNAME=elisio

#@REM ==== JAVA NAMING STUFF ====
export JAVAPROJ_NAME=sdproject
export JAVAPROJ=/home/elisio/IdeaProjects/${JAVAPROJ_NAME}

export PACKAGE=sd
export PACKAGE_PREFIX=edu.ufp.inf
export PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/
export SERVICE_NAME_ON_REGISTRY=SDProject
